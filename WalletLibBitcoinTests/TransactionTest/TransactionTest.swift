...
final class TransactionTest: XCTestCase {
    ...
    func testCalculateTransactionFee() {
        ...
        let testData = TransactionTestVector.vector
        ...
        for testItem in testData {
            ...
            let calculator = FeeCalculator(amount: UInt64(testItem.amount), utxo: utxo, isSendAll: false)
    ...
    func testCreateSignBitcoinTransaction() {
        let vector = TransactionTestVector.vector

        for vectorItem in vector {
            
            let unspentOutputs = vectorItem.unspent.compactMap({
            ...
            let params: BitcoinTransactionParameters = .new
                .amount(UInt64(vectorItem.amount))
                .to(vectorItem.address)
                .change(vectorItem.changeAddress)
                .utxo(unspentOutputs)
                .sendAll(false)
            ...
            guard let tx = try? builder.buildTransaction(feeAmount: UInt64(vectorItem.fee)) else {
            ...
            XCTAssertTrue(signedtx.id == vectorItem.resultHash, "Transaction id invalid. Expected: \(vectorItem.resultHash) Result \(signedtx.id)")
    ...
    func testCreateWitnessBitcoinTransactionP2WPKH() {
        ...
        let key1 = KeySecp256k1(privateKey: Data(hex: "bbc27228ddcb9209d7fd6f36b02f7dfa6252af40bb2f1cbc7a557da8027ff866"))
        let key2 = KeySecp256k1(privateKey: Data(hex: "619c335025c7f4012e556c2a58b2506e30b8511b53ade95ea316fd8c3286feb9"))
    ...
    func testCreateWitnessBitcoinTransactionP2SH_P2WPKH() {
        ...
        let key = KeySecp256k1(privateKey: Data(hex: "eb696a065ef48a2192da5b28b694f87544b30fae8327c4510137a922f32c6dcf"))
